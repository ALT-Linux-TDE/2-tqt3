...
void Main::testAll()
{
...
#if 0
    system("mv ../include/tqconfig.h ../include/tqconfig.h-orig");
    for (TQStringList::ConstIterator it = choices.begin(); it != choices.end(); ++it)
    {
	TQString choice = *it;
	TQFile f("../include/tqconfig.h");
	f.open(IO_WriteOnly);
	TQCString s = "#define ";
	s += choice.latin1();
	s += "\n";
    ...
    system("mv ../include/tqconfig.h-orig ../include/tqconfig.h");
#endif
}
...
void Main::about()
{
    TQMessageBox::about(this, "About tqconfig",
...
void Main::aboutTQt()
{
    TQMessageBox::aboutTQt( this, tr("tqconfig") );
}
...
int main(int argc, char** argv)
{
    ...
    TQString tqconfig = qtdir + "/include/tqconfig.h";
