...
bool TQUic::isMainWindow = FALSE;

TQString TQUic::getComment( const TQDomNode& n )
{
...
TQString TQUic::mkBool( bool b )
{
    return b? "TRUE" : "FALSE";
}

TQString TQUic::mkBool( const TQString& s )
{
    return mkBool( s == "true" || s == "1" );
}

bool TQUic::toBool( const TQString& s )
{
    return s == "true" || s.toInt() != 0;
}

TQString TQUic::fixString( const TQString &str, bool encode )
{
    TQString s;
    if ( !encode ) {
	s = str;
...
TQString TQUic::trcall( const TQString& sourceText, const TQString& comment )
{
...
TQString TQUic::mkStdSet( const TQString& prop )
{
...
/*!
  ...
  The class TQUic encapsulates the user interface compiler (tquic).
 */
TQUic::TQUic( const TQString &fn, const char *outputFn, TQTextStream &outStream,
 ...
 */
TQString TQUic::getPixmapLoaderFunction( const TQDomElement& e )
{
    TQDomElement n;
 ...
 */
TQString TQUic::getFormClassName( const TQDomElement& e )
{
    TQDomElement n;
    TQString cn;
    for ( n = e.firstChild().toElement(); !n.isNull(); n = n.nextSibling().toElement() ) {
 ...
 */
TQString TQUic::getClassName( const TQDomElement& e )
{
...
bool TQUic::isFrameworkCodeGenerated( const TQDomElement& e )
{
...
/*! Extracts an object name from \a e. It's stored in the 'name'
 property.
 */
TQString TQUic::getObjectName( const TQDomElement& e )
{
 ...
 */
TQString TQUic::getLayoutName( const TQDomElement& e )
{
...
TQString TQUic::getDatabaseInfo( const TQDomElement& e, const TQString& tag )
{
    TQDomElement n;
    TQDomElement n1;
    int child = 0;
...
void TQUic::registerLayouts( const TQDomElement &e )
{
 ...
 */
TQString TQUic::getInclude( const TQString& className )
{
...
void TQUic::createActionDecl( const TQDomElement& e )
{
...
void TQUic::createToolbarDecl( const TQDomElement &e )
{
    if ( e.tagName() == "toolbar" )
	out << "    " << "TQToolBar *" << getObjectName( e ) << ";" << endl;
}

void TQUic::createMenuBarDecl( const TQDomElement &e )
{
    if ( e.tagName() == "item" ) {
...
void TQUic::createPopupMenuDecl( const TQDomElement &e )
{
    for ( TQDomElement n = e.firstChild().toElement(); !n.isNull(); n = n.nextSibling().toElement() ) {
	if ( n.tagName() == "action" || n.tagName() == "actiongroup" ) {
...
void TQUic::createActionImpl( const TQDomElement &n, const TQString &parent )
{
...
void TQUic::createToolbarImpl( const TQDomElement &n, const TQString &parentClass, const TQString &parent )
{
...
void TQUic::createMenuBarImpl( const TQDomElement &n, const TQString &parentClass, const TQString &parent )
{
...
void TQUic::createPopupMenuImpl( const TQDomElement &e, const TQString &parentClass, const TQString &parent )
{
    int i = 0;
    for ( TQDomElement n = e.firstChild().toElement(); !n.isNull(); n = n.nextSibling().toElement() ) {
	if ( n.tagName() == "action" || n.tagName() == "actiongroup" ) {
...
TQString TQUic::createListBoxItemImpl( const TQDomElement &e, const TQString &parent,
				    TQString *value )
{
...
TQString TQUic::createIconViewItemImpl( const TQDomElement &e, const TQString &parent )
{
    TQDomElement n = e.firstChild().toElement();
    TQString txt;
    TQString com;
...
TQString TQUic::createListViewItemImpl( const TQDomElement &e, const TQString &parent,
...
TQString TQUic::createListViewColumnImpl( const TQDomElement &e, const TQString &parent,
				       TQString *value )
{
    TQDomElement n = e.firstChild().toElement();
    TQString txt;
...
TQString TQUic::createTableRowColumnImpl( const TQDomElement &e, const TQString &parent,
				       TQString *value )
{
 ...
 */
TQString TQUic::createLayoutImpl( const TQDomElement &e, const TQString& parentClass, const TQString& parent, const TQString& layout )
{
    TQDomElement n;
...
TQString TQUic::createSpacerImpl( const TQDomElement &e, const TQString& /*parentClass*/, const TQString& /*parent*/, const TQString& /*layout*/)
{
    TQDomElement n;
    TQString objClass, objName;
    objClass = e.tagName();
 ...
 */
void TQUic::createColorGroupImpl( const TQString& name, const TQDomElement& e )
{
    TQColorGroup cg;
    int r = -1;
    TQDomElement n = e.firstChild().toElement();
...
/*!
  ...
  contain pixmaps.
 */
TQColorGroup TQUic::loadColorGroup( const TQDomElement &e )
{
    TQColorGroup cg;
    int r = -1;
    TQDomElement n = e.firstChild().toElement();
...
bool TQUic::isWidgetInTable( const TQDomElement& e, const TQString& connection, const TQString& table )
{
...
void TQUic::registerDatabases( const TQDomElement& e )
{
    TQDomElement n;
    TQDomNodeList nl;
    int i;
 ...
 */
TQString TQUic::registerObject( const TQString& name )
{
 ...
 */
TQString TQUic::registeredName( const TQString& name )
{
 ...
 */
bool TQUic::isObjectRegistered( const TQString& name )
{
 ...
 */
TQStringList TQUic::unique( const TQStringList& list )
{
    if ( list.isEmpty() )
	return list;
 ...
 */
TQString TQUic::createObjectInstance( const TQString& objClass, const TQString& parent, const TQString& objName )
{
...
bool TQUic::isLayout( const TQString& name ) const
{
