...
/*!
  ...
  \sa createObjectImpl()
 */
void TQUic::createObjectDecl( const TQDomElement& e )
{
    if ( e.tagName() == "vbox" ) {
...
void TQUic::createSpacerDecl( const TQDomElement &e )
{
 ...
 */
void TQUic::createExclusiveProperty( const TQDomElement & e, const TQString& exclusiveProp )
{
    TQDomElement n;
    TQString objClass = getClassName( e );
    if ( objClass.isEmpty() )
 ...
 */
TQString TQUic::setObjectProperty( const TQString& objClass, const TQString& obj, const TQString &prop, const TQDomElement &e, bool stdset )
{
    TQString v;
    if ( e.tagName() == "rect" ) {
 ...
 */
TQDomElement TQUic::getObjectProperty( const TQDomElement& e, const TQString& name )
{
    TQDomElement n;
