...
void TQWidget::destroy( bool destroyWindow, bool destroySubWindows )
{
	...
	extern void qPRCleanup( TQWidget *widget ); // from tqapplication_x11.cpp
...
void TQWidget::internalSetGeometry( int x, int y, int w, int h, bool isMove )
{
	...
	if ( isResize ) {
	    ...
	    // set config pending only on resize, see tqapplication_x11.cpp, translateConfigEvent()
...
/*!
    ...
    execute text operations properly. See tqlineedit.cpp and tqtextedit.cpp as
    example.
