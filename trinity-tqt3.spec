...
BuildRequires: glibc-devel glibc-utils
%if "%{?c_compiler}" != "clang"
BuildRequires: gcc-c++
%endif
...
%else
BuildRequires: agetty cfdisk fdisk getopt hardlink hwclock look losetup mount rfkill schedutils setarch sfdisk util-linux
%endif
%endif
...
%if 0%{?rhel} == 5
sed -i "src/sql/drivers/mysql/qsql_mysql.cpp" -e "s|bool reconnect = 0;|my_bool reconnect = 0;|g"
%endif
...
%changelog
* Thu Jan 02 2025 Petr Akhlamov <ahlamovpm@basealt.ru> 3.5.0-alt1_14.1.3_1
