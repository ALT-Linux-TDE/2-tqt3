...
BuildRequires: glibc-devel-static-static
BuildRequires: gcc-c++
BuildRequires: make
...
# FREETYPE support
BuildRequires: liblibfreetype-devel
...
Requires: glibc-devel-static-static
Requires: libfontconfig-devel
Requires: liblibfreetype-devel
...
%_bindir/tqmoc
%_bindir/tqembed
%_man1dir/lupdate-tqt3.1*
%_man1dir/lrelease-tqt3.1*
%_man1dir/moc-tqt3.1*
%_man1dir/uic-tqt3.1*
...
%_iconsdir/hicolor/32x32/apps/tqdesigner.png
...
%_iconsdir/hicolor/32x32/apps/tqlinguist.png
...
%_bindir/tqassistant
%_iconsdir/hicolor/32x32/apps/tqassistant.png
...
%_iconsdir/hicolor/32x32/apps/tqtconfig.png
...
%if 0%{?rhel} == 5
%__subst "src/kernel/ntqstyle.h" -e "s|#ifdef ENABLE_T*QSTYLECONTROLELEMENTDATA_SLOW_COPY|#if 1|"
%endif
...
# fix .prl files
%__subst lib/*.prl -e "s|${QTDIR}|%_datadir/tqt3|g"
...
make -C src INSTALL_ROOT="%{?buildroot}" install_target

# Installs all the remaining
make INSTALL_ROOT=%{?buildroot} install
make INSTALL_ROOT=%{?buildroot} plugins-install
...
%__subst 's{\$$\$$QT_SOURCE_TREE}{$(QTDIR)}' "src/qt_professional.pri"
...
# desktop lnk files
install -m644 -D "%SOURCE11" "%{?buildroot}%_desktopdir/tqassistant.desktop"
install -m644 -D "%SOURCE12" "%{?buildroot}%_desktopdir/tqdesigner.desktop"
install -m644 -D "%SOURCE13" "%{?buildroot}%_desktopdir/tqlinguist.desktop"
install -m644 -D "%SOURCE14" "%{?buildroot}%_desktopdir/tqtconfig.desktop"
...
install -m644 -D "tools/assistant/images/appicon.png" "%{?buildroot}%_iconsdir/hicolor/32x32/apps/tqassistant.png"
install -m644 -D "tools/designer/designer/images/designer_appicon.png" "%{?buildroot}%_iconsdir/hicolor/32x32/apps/tqdesigner.png"
install -m644 -D "tools/linguist/linguist/images/appicon.png" "%{?buildroot}%_iconsdir/hicolor/32x32/apps/tqlinguist.png"
install -m644 -D "tools/qtconfig/images/appicon.png" "%{?buildroot}%_iconsdir/hicolor/32x32/apps/tqtconfig.png"
...
%changelog
* Fri May 12 2017 Hihin Ruslan <ruslandh@altlinux.ru> 3.5.0-alt1
